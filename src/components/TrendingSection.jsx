...
// The main section component remains the same. It's already great.
  ...
  return (
    <section className="relative w-full bg-gray-900 text-white py-20 md:py-28 font-sans overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto">
            ...
            {/* MINOR CHANGE: Updated the descriptive text for the new interaction */}
...
// NO CHANGES NEEDED for the CourseCard component. It remains the same.
